    ...
    return (
        ...
        >
            ...
            <div className="grid grid-cols-1 min-[800px]:grid-cols-2 xl:grid-cols-4 gap-4">
                ...
                <motion.div className="items" {...cardAnim(0.1)}>
                    <div
                    ...
                    >
                        <div className="h-[200px] lg:h-[200px] min-[1920px]:h-[307px] bg-no-repeat bg-cover bg-center justify-end flex rounded-[40px] transition-all duration-500 ease-in-out bg-Pharmacy group-hover:bg-none">
                            <div className="circle-btn m-4 group-hover:rotate-45" style={{ backgroundColor: 'white', border: '2px solid #C5E5FF' }}>
                ...
                <motion.div className="items" {...cardAnim(0.25)}>
                    <div
                        onClick={() => navigate('/clinic')}
                        className="group relative min-h-[300px] lg:h-[300px] min-[1920px]:h-[400px] w-screen bg-white rounded-[40px] overflow-hidden transition duration-300 hover:bg-[#213170] hover:shadow-xl hover:border-white hover:border-solid hover:border-[2px]"
                    >
                        <div className="h-[200px] lg:h-[200px] min-[1920px]:h-[307px] bg-no-repeat bg-center bg-cover justify-end flex rounded-[40px] transition-all duration-500 ease-in-out bg-Clinic group-hover:bg-none">
                            <div className="circle-btn m-4 group-hover:rotate-45" style={{ backgroundColor: 'white', border: '2px solid #C5E5FF' }}>
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="20" height="20">
                                    <path fill="currentColor" fillRule="evenodd" d="M9 6.75a.75.75 0 0 1 0-1.5h9a.75.75 0 0 1 .75.75v9a.75.75 0 0 1-1.5 0V7.81L6.53 18.53a.75.75 0 0 1-1.06-1.06L16.19 6.75z" clipRule="evenodd"></path>
                                </svg>
                ...
                <motion.div className="items" {...cardAnim(0.4)}>
                    <div
                        onClick={() => navigate('/drugs')}
                        className="group relative min-h-[300px] lg:h-[300px] min-[1920px]:h-[400px] w-screen bg-white rounded-[40px] overflow-hidden transition duration-300 hover:bg-[#213170] hover:shadow-xl hover:border-white hover:border-solid hover:border-[2px]"
                    >
                        <div className="h-[200px] lg:h-[200px] min-[1920px]:h-[307px] bg-no-repeat bg-center bg-cover justify-end flex rounded-[40px] transition-all duration-500 ease-in-out bg-Drugs group-hover:bg-none">
                            <div className="circle-btn m-4 group-hover:rotate-45" style={{ backgroundColor: 'white', border: '2px solid #C5E5FF' }}>
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="20" height="20">
                                    <path fill="currentColor" fillRule="evenodd" d="M9 6.75a.75.75 0 0 1 0-1.5h9a.75.75 0 0 1 .75.75v9a.75.75 0 0 1-1.5 0V7.81L6.53 18.53a.75.75 0 0 1-1.06-1.06L16.19 6.75z" clipRule="evenodd"></path>
                                </svg>
                ...
                <motion.div className="items" {...cardAnim(0.55)}>
                    <div
                        onClick={() => navigate('/disease')}
                        className="group relative min-h-[300px] lg:h-[300px] min-[1920px]:h-[400px] w-screen bg-white rounded-[40px] overflow-hidden transition duration-300 hover:bg-[#213170] hover:shadow-xl hover:border-white hover:border-solid hover:border-[2px]"
                    >
                        <div className="h-[200px] lg:h-[200px] min-[1920px]:h-[307px] justify-end flex rounded-[40px] bg-no-repeat bg-center bg-cover transition-all duration-500 ease-in-out bg-Disease group-hover:bg-none">
                            <div className="circle-btn m-4 group-hover:rotate-45" style={{ backgroundColor: 'white', border: '2px solid #C5E5FF' }}>
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="20" height="20">
                                    <path fill="currentColor" fillRule="evenodd" d="M9 6.75a.75.75 0 0 1 0-1.5h9a.75.75 0 0 1 .75.75v9a.75.75 0 0 1-1.5 0V7.81L6.53 18.53a.75.75 0 0 1-1.06-1.06L16.19 6.75z" clipRule="evenodd"></path>
                                </svg>
