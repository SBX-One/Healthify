...
export const ExpPharmacy = () => {
    ...
    return (
        <div ref={ref} className="flex flex-col xl:grid xl:grid-cols-6 gap-4 mb-4">
            ...
            <motion.div className="items col-start-5 xl:col-span-2" {...cardAnim(0)}>
                <div onClick={() => navigate('/pharmacy')} className="BOX2 bg-[#C5E5FF] flex flex-col w-screen h-screen justify-between p-8 group">
                    <div className="flex flex-col gap-4">
                        <div className="flex justify-between">
                            ...
                            <div className="circle-btn bg-white group-hover:rotate-45 group-hover:bg-[#213170] group-hover:border-[3px] group-hover:border-solid group-hover:border-[#C5E5FF]">
            ...
            <motion.div className="items col-start-3 xl:col-span-2" {...cardAnim(0.2)}>
            ...
            <motion.div className="items col-start-1 xl:col-span-2" {...cardAnim(0.4)}>
