        ...
        <motion.div ref={ref} initial={{ opacity: 0, y: 100 }} animate={inView ? { opacity: 1, y: 0 } : {}} transition={{ duration: 1 }} className=" flex  flex-col gap-4 ">
            <div className="items">
                ...
                >
                    ...
                    <div className="circle-btn bg-[#C5E5FF] group-hover:rotate-45 group-hover:bg-[#213170] group-hover:border-[3px] group-hover:border-solid group-hover:border-[#C5E5FF]">
