...
export const ExpClinic = () => {
    ...
    return (
        <div ref={ref} className="flex flex-col xl:grid xl:grid-cols-6 gap-4 mb-4">

            <motion.div className="items xl:col-span-2" {...cardAnim(0)}>
                <div onClick={() => navigate('/clinic')} className="BOX2 bg-[#213170] w-screen flex flex-col h-screen justify-between p-8 group">
                    <div className="flex flex-col gap-4">
                        <div className="flex justify-between">
                            ...
                            <div className="circle-btn bg-[#C5E5FF] group-hover:rotate-45 group-hover:bg-white group-hover:border-[3px] group-hover:border-solid group-hover:border-[#C5E5FF]">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="20" height="20">
                                    <path fill="black" className="group-hover:fill-[#213170]" fillRule="evenodd" d="M9 6.75a.75.75 0 0 1 0-1.5h9a.75.75 0 0 1 .75.75v9a.75.75 0 0 1-1.5 0V7.81L6.53 18.53a.75.75 0 0 1-1.06-1.06L16.19 6.75z" clipRule="evenodd"></path>
                                </svg>
                            </div>
                        </div>
            ...
            <motion.div className="items xl:col-span-2" {...cardAnim(0.2)}>
                <div onClick={() => navigate('/clinic')} className="BOX2 flex flex-col h-screen w-screen justify-between bg-Clinic2 bg-cover">
                    <div className="p-4 lg:p-8 flex flex-col justify-between h-screen hover:bg-blue-300 hover:bg-opacity-40 rounded-[40px] group">
                        <div className="circle-btn self-end bg-white group-hover:rotate-45 group-hover:bg-[#213170] group-hover:border-[3px] group-hover:border-solid group-hover:border-[#C5E5FF]">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="20" height="20">
                                <path fill="black" className="group-hover:fill-[#C5E5FF]" fillRule="evenodd" d="M9 6.75a.75.75 0 0 1 0-1.5h9a.75.75 0 0 1 .75.75v9a.75.75 0 0 1-1.5 0V7.81L6.53 18.53a.75.75 0 0 1-1.06-1.06L16.19 6.75z" clipRule="evenodd"></path>
                            </svg>
                        </div>
            ...
            <motion.div className="items xl:col-span-2" {...cardAnim(0.4)}>
